              ...
              <div className="flex space-x-4">
                {publicNavigation.map((item) => (
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      classNames(
                        isActive ? 'bg-white rounded-full text-black' : 'text-white hover:text-black',
                ...
                {auth.auth && privateNavigation.map((item) => (
                  <NavLink
                    key={item.name}
                    to={item.href}
                    className={({ isActive }) =>
            ...
            {auth.auth ? (
              ...
              <div className="flex items-center space-x-4">
                <NavLink to="/signin" className="text-white hover:text-black">
                  <button className='py-2 px-6 rounded-md text-white'>Sign in now to unlock additional features and enhance your experience!</button>
                </NavLink>
              </div>
            )}
          </div>
        ...
        <div className="space-y-1 px-2 pb-3 pt-2">
          ...
          {auth.auth && auth.role === "farmer" && (
            <DisclosureButton
              ...
              className={({ isActive }) =>
                classNames(
                  isActive ? 'bg-white text-black rounded-md' : 'text-white hover:text-black',
                  'block rounded-md px-3 py-2 text-base font-medium transition-all duration-300'
                )
              }
            >
